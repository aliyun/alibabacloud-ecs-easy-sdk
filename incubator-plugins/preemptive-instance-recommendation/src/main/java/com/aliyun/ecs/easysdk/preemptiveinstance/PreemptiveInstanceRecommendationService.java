...
public interface PreemptiveInstanceRecommendationService {

    Response<List<PreemptiveInstanceRecommendation>> recommend(PreemptiveInstanceRecommendationRequest request);
