 ...
 */
package com.aliyun.ecs.easysdk.preemptiveinstance.demos.entrylevel;
...
public class EntryLevelRecommendDemo {
    ...
    /**
     * 全地域，指定机型的入门级抢占式实例推荐；由于地域较多，全地域推荐耗时相对更长
     * @param preemptiveInstanceRecommendationService 抢占式实例推荐服务
     * @param preemptiveInstanceBaseService 抢占式实例基本服务
     */
